...
def subject_card(name, code, section, stats=None, footer_callback=None):
    ...
    <p style="margin:10px 0; color: #64748b;">Code: <span style="border-radius:4px; background:#E0E3FF; font-weight: bold; color:#5865F2; padding:2px 8px">{code}</span> | Section: <span style="border-radius:4px; background:#E0E3FF; font-weight: bold; color:#5865F2; padding:2px 8px">{section}</span></p>
    """
